...
public class ChatController {
    ...
    MovieRecommendationResponse movieRecommendation(@RequestBody TextRequest requestBody) {
        return chatService.movieRecommendation(requestBody.message(), requestBody.conversationId());
    }
}
